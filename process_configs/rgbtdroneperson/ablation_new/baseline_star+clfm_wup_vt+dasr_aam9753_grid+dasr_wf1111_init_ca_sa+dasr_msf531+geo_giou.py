...
model = dict(
    ...
    wf_use_sa=[True, True, True, True],
    wf_use_ca=[True, True, True, True],
...
work_dir = 'work_dir/rgbtdroneperson/ablation_new/baseline_star+clfm_wup_vt+dasr_aam9753_grid+dasr_wf1111_init_ca_sa+dasr_msf531+geo_giou.py'
