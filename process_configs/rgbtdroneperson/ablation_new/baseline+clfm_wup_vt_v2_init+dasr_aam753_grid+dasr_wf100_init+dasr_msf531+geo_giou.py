...
model = dict(
    ...
    use_wf=[True, False, False],
    wf_initialize=[True, False, False],
...
work_dir = 'work_dir/rgbtdroneperson/ablation_new/baseline+clfm_wup_vt_v2_init+dasr_aam753_grid+dasr_msf531+geo_giou'
