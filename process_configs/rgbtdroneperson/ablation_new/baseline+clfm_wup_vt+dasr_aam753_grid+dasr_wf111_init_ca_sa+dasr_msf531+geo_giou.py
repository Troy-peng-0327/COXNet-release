...
model = dict(
    ...
    use_grid=True,
    aam_kernels=[7, 5, 3],
    aam_range_factor=[1, 1, 1],
    use_wf=[True, True, True],
    wf_initialize=[True, True, True],
    wf_use_sa=[True, True, True],
    wf_use_ca=[True, True, True],
    use_msf=[True, True, True],
    msf_kernels=[5, 3, 1],
...
work_dir = 'work_dir/rgbtdroneperson/ablation_new/baseline+clfm_wup_vt+dasr_aam753_grid+dasr_wf111_init_ca_sa+dasr_msf531+geo_giou'
