...
model = dict(
    ...
    fs_type='dasr',
    use_clfm=['wup_vt_v2'],
    clfm_initialize=True,
    use_aam=True,
    use_grid=True,
    aam_kernels=[9, 7, 5, 3],
    aam_range_factor=[1, 1, 1, 1],
    use_wf=[True, True, False, False],
    wf_initialize=[True, True, False, False],
    use_msf=[True, True, True, True],
    msf_kernels=[5, 3, 1],
...
work_dir = 'work_dir/rgbtdroneperson/ablation_new/baseline_star+clfm_wup_vt_v2_init+dasr_aam9753_grid+dasr_wf1100_init+dasr_msf531+geo_giou'
