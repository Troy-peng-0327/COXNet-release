...
model = dict(
    ...
    use_wf=['fusion_v3', 'fusion_v3', 'fusion_v3', 'fusion_v3'],
    wf_loss=['t'],
...
work_dir = 'work_dir/rgbtdroneperson/ablation_new/baseline_star+clfm_wup_vt_v5+dasr_aam9753_grid+dasr_wf1111_v3_loss+dasr_msf753+geo_giou'
