...
model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='checkpoints/resnet50_rgbt_6ch_avg.pth')),
    neck=dict(
        type='FPN',
...
work_dir = 'work_dir/rgbtdroneperson/atss/atss_rgbt_6ch_avg_stage2_r50_fpn_1x'

load_from = 'checkpoints/resnet50_rgbt_6ch_avg_stage1.pth'