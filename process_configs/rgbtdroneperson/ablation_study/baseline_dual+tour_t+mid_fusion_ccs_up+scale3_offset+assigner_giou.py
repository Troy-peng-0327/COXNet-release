...
model = dict(
    ...
    fs_type='tour_t_offset_scale_attention',
    scale_mode='scale3',
    # usepoolup=True,
...
work_dir = 'work_dir/rgbtdroneperson/ablation_study/baseline_dual+tour_t+mid_fusion_ccs_up+scale3_offset+assigner_giou'
