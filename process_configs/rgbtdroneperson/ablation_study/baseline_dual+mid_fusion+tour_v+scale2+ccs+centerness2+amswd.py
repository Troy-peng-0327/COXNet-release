...
model = dict(
    ...
    backbone=dict(
        ...
        use_fusion=True,
        fuse_indice=(0, 1, 2),
        fuse_modes=['chn', 'chn', 'spa'],
        fuse_reduction=(8, 16, 32),
        fuse_upsample=(True, True, True),
        # one_output=True,
        # out_reduction=(8, 16, 32, 64),
        # out_upsample=(True, True, True, True),
        style='pytorch',
    ...
    fs_type='tour_v_scale_attention',
...
work_dir = 'work_dir/rgbtdroneperson/ablation_study/baseline_dual+tour_v+scale2+ccs+centerness2+amswd'
