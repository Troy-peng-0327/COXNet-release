...
teacher_ckpt = 'work_dir/rgbtdroneperson/gfl/gfl_rgbt_star_6ch_avg_r50_fpn_1x/epoch_10.pth'  # noqa
model = dict(
    type='KnowledgeDistillationRGBTSingleStageDetector',
    teacher_config='work_dir/rgbtdroneperson/gfl/gfl_rgbt_star_6ch_avg_r50_fpn_1x/gfl_rgbt_star_6ch_avg_r50_fpn_1x.py',
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='checkpoints/resnet18_rgbt_6ch_avg.pth')),
    neck=dict(
        type='FPN',
...
work_dir = 'work_dir/rgbtdroneperson/ld/ld_rgbt_r18_gfl_star_r50_fpn_1x'
