...
model = dict(
    ...
    backbone_t=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='checkpoints/resnet50_thermal_stage2.pth')),
    neck=dict(
        type='FPN',
...
work_dir = 'work_dir/rgbtdroneperson/gfl/gfl_hcf_tour_t_2pre_r50_fpn_1x'